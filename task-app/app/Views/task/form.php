...
<div class="container mt-5">
  <div class="row justify-content-center">
    ...
    <div class="mb-3">
      ...
      <h2 class="mb-4 text-center"><?= lang('Task.newTaskTitle') ?></h2>
    </div>

      <form action="/tasks/new" method="post">
        <div class="mb-3">
          <label for="description" class="form-label"><?= lang('Task.descriptionLabel') ?></label>
          <textarea name="description" id="description" class="form-control" rows="8" minlength="3" maxlength="255" required></textarea>
