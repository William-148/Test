...
<?= $this->section('content') ?>
    ...
    <div class="col-md-6 col-lg-5">
      <div class="mb-3">
        ...
        <h2 class="mb-4 text-center"><?= lang('SignUp.titleAdmin') ?></h2>
      </div>

      <form id="signUpForm" action="/users/new" method="post">
        <div class="mb-3">
        ...
        <div class="d-flex justify-content-between">
          <button type="submit" class="btn btn-primary"><?= lang('SignUp.submitAdmin') ?></button>
