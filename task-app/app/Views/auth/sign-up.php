...
<main class="container py-5">
  <div class="row justify-content-center">
    <div class="col-md-6 col-lg-5">
      <h2 class="mb-4 text-center"><?= lang('SignUp.title') ?></h2>
      ...
      <form id="signUpForm" action="/sign-up" method="post">
        ...
        <div class="d-flex justify-content-between">
          <button type="submit" class="btn btn-primary"><?= lang('SignUp.submit') ?></button>
          <a href="/" class="btn btn-secondary"><?= lang('SignUp.cancel') ?></a>
        </div>
      </form>
    </div>
  </div>
